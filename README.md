...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3 align="center">GreenHeaven</h3>
      <div align="center">
        <a href="https://github.com/yourusername/greenheaven" target="_blank">
          <img src="https://dummyimage.com/600x400/4CAF50/ffffff&text=GreenHeaven" width="100%" alt="GreenHeaven"/>
        </a>
        <p><strong>A comprehensive online plant-selling platform</strong></p>
        <p>GreenHeaven is designed for plant lovers to browse, purchase, and learn about different plants. Features include: product catalog, cart management, order tracking, and responsive UI.</p>
        <div align="center">
